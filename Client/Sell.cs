...
namespace Joeun_Convenience_store
{
    ...
    {     
                ...
                foreach (Control control in flowLayoutPanel1.Controls)
                {
                    if (control is CheckBox checkBox && checkBox.Checked)
                    {
                        ...
                        else
                        {
                            ...
                            string updateQuery = $@"
                     BEGIN
                            UPDATE Inventory_Status SET ""판매량"" = ""판매량"" + {quantity} WHERE ""제품명"" = '{productName}';
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                connection.Open();
                string updateQuery = $"UPDATE Inventory_Status SET \"판매량\" = 0";
                OracleCommand updateCommand2 = new OracleCommand(updateQuery, connection);
